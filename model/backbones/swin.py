...
from ..mmcv_custom import load_checkpoint, get_root_logger
    ...
    def forward(self, x):
        ...
        for i in range(self.num_layers):
            ...
            if i in self.out_indices:
                ...
                out = norm_layer(x_out)  # output of a Block has shape (B, H*W, dim)
...
class BasicLayer(nn.Module):
    ...
    def forward_pre_downsample(self, x, H, W):
        """ Forward function (before downsample).
    ...
    def forward_downsample(self, x, H, W):
